...
then
    ...
    sudo rm /opt/adlink/eva/plugins/libassembly.so
    message_out "sudo rm /opt/adlink/eva/plugins/libassembly.so is removed."
else
...
sudo cp ./build/libassembly.so /opt/adlink/eva/plugins/.
